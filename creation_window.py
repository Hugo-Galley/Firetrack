...
import user_main_windows, window, database
...
class CreationWindow(window.Window):
    ...
    def create_room(self):
        ## password = Admin
        if  hashlib.sha256(self.entry_frame.room_password_entry.get().encode('utf-8')).hexdigest()  and   hashlib.sha256(self.entry_frame.username_entry.get().encode('utf-8')).hexdigest() == 'c1c224b03cd9bc7b6a86d77f5dace40191766c485cd55dc48caf9ac873335d6f':
