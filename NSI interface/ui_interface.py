...
################################################################################
## Form generated from reading UI file 'interfacetxdQPq.ui'
##
...
"}")
        ...
        font = QFont()
        font.setFamily(u"Noto Sans Black")
...
"color: rgb(255, 255, 255);")
        ...
        self.page.setGeometry(QRect(0, 0, 200, 200))
        ...
        icon1 = QIcon()
        icon1.addFile(u":/icons/icons/inbox.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.toolBox.addItem(self.page, icon3, u"Music Room")
        self.page_2 = QWidget()
        self.page_2.setObjectName(u"page_2")
        self.page_2.setGeometry(QRect(0, 0, 200, 222))
...
"border-radius: 30px;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(QCoreApplication.translate("MainWindow", u"FIRETRACK", None))
        ...
        self.pushButton_12.setText(QCoreApplication.translate("MainWindow", u"BLACKOUT", None))
        self.toolBox.setItemText(self.toolBox.indexOf(self.page), QCoreApplication.translate("MainWindow", u"Music Room", None))
        ...
        self.label.setText(QCoreApplication.translate("MainWindow", u"Desperados_UI.ver-9/11", None))
